...
namespace cinfo
{
	...
	public:
		...
		void run(threaded_process_status& status, abort_callback& abort) override
		{
			...
			FB2K_console_print(component_name, ": ", count, " items scanned.");
			FB2K_console_print(component_name, ": ", files, " files are capable of containing covers.");
			FB2K_console_print(component_name, ": ", found, " files have covers.");
		}
